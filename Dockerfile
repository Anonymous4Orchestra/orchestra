...
RUN wget https://github.com/Anonymous4Orchestra/pfuzzer/releases/download/Alpha0.3/fuzzers.tgz && \
...
RUN git clone https://github.com/Anonymous4Orchestra/hfc-introspector.git && \
...
RUN git clone --depth 1 https://github.com/Anonymous4Orchestra/orchestra.git && \
