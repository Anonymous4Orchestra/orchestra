...
WORKDIR /opt
RUN wget https://github.com/Anonymous4Orchestra/pfuzzer/releases/download/Alpha0.3/targets.tgz && \
    tar -xzf targets.tgz && rm targets.tgz && \
    wget https://github.com/Anonymous4Orchestra/pfuzzer/releases/download/Alpha0.3/seeds.tgz && \
